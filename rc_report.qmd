...
::: {#first-column}
Les **papillons** sont les seuls poissons observés en 2024 et dont la densité semble diminuer depuis 2013. L'observation de poissons perroquets
...
::: {#first-column}
Les **papillons** représentent la principale famille de poisson observé en 2024 (@fig-fish-mtsangamouji). Cette famille est en augmentation depuis 2012,
...
## Communautés benthiques en 2024 et évolution
::: {#first-column}
Les invértébrés sont **faiblement représentés** sur cette station en 2024 (@fig-invert-pes.deux). En particulier, on note une tandance à la baisse des **holothuries**, espèces d'interêts
...
## Communautés benthiques en 2024 et évolution
::: {#first-column}
Les peuplements d'invertébrés sont **très faiblement représentés** en 2024 et majoritaiement par les **oursins diadèmes** sur l'ensemble de
