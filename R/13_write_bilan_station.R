  ...
  bilan_station <- list(
    ...
    mbouzi = list(
      ...
      **roche, débris et sable** (@fig-sub-mbouzi). Le recouvrement **biotique** est principalement partagé entre le **corail dur et le corail mou**.
      ...
      fish = glue::glue("Les **papillons** sont les seuls poissons observés en 2024, dont la densité diminue depuis 2013. L'observation de poissons **perroquets**
    ...
    tanaraki = list(
      ...
      invert = glue::glue("Les peuplements d'invertébrés sont **très faiblement représentés** en 2024 et majoritairement par les **oursins diadèmes** sur l'ensemble de
